...
const SideBar = () => {
  ...
  return (
    <div className="h-screen">
      ...
      {/* Sidebar */}
      <div
        className={`fixed h-full bg-gradient-to-b from-blue-800 to-blue-600 text-gray-400 border-r border-blue-700/30 shadow-xl transition-transform duration-300 ${
          ...
          <nav>
            <ul>
              <li className="mb-4">
                <Link
                  to={`/admin/${id}`}
                  className={`flex items-center text-lg p-3 rounded-lg transition-all duration-300 ease-in-out ${
                    isActive("/admin")
