...
import { FaUser, FaBook, FaUserGraduate, FaChalkboardTeacher } from "react-icons/fa";
    ...
    return (
      <div className="fixed top-16 left-0 h-full w-64 bg-gradient-to-b from-blue-800 to-blue-500 text-white flex flex-col backdrop-blur-lg">
        ...
        <ul className="space-y-3">
          ...
          >
            <FaBook size={20} className={`transition-colors duration-300 ${
          ...
          >
            <FaUserGraduate size={20} className={`transition-colors duration-300 ${
              isActive(`/student/${id}/upload/${rollNo}`) ? "text-blue-600" : ""
            }`} />
            <span className="pl-4 font-medium">Upload Assignment</span>
          </Link>
          </li>
          <li>
          <Link
          ...
          >
            <FaChalkboardTeacher size={20} className={`transition-colors duration-300 ${
              isActive(`/student/${id}/experiments/${rollNo}`) ? "text-blue-600" : ""
            }`} />
